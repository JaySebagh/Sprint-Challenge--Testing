...
`it()` allows you to run the tests while `describe()` allows you to organize your `it()`s



2. What is the point of `Test Driven Development`? What do you think about this approach?

TDD focuses on writing tests first instead of coding. TDD supposedly makes writing tests easier. Not sure on how I feel about the approach.
